        ...
        AsyncConfigurer, SchedulingConfigurer
{
    ...
    {
    	/*JndiDataSourceLookup lookup = new JndiDataSourceLookup();return lookup.getDataSource("jdbc/CustomerSupport");*/
    	DriverManagerDataSource dataSource= new DriverManagerDataSource();
    	dataSource.setUrl("jdbc:sqlserver://localhost:1433;databaseName=CustomerSupport");
    	dataSource.setUsername("sa");
    	dataSource.setPassword("DA_2014");
